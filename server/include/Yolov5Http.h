...
#ifndef __YOLOV5HTTP_H_
#define __YOLOV5HTTP_H_
...
namespace dummy
{
    ...
    class Yolov5HttpPrxCallback: public tars::ServantProxyCallback
    {
    public:
        virtual ~Yolov5HttpPrxCallback(){}
    ...
    public:
        ...
        {
            static ::std::string __Yolov5Http_all[]=
            {
                "test"
            };
            auto it = _msg_->response->status.find("TARS_FUNC");
            pair<string*, string*> r = equal_range(__Yolov5Http_all, __Yolov5Http_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Yolov5Http_all)
            {
                case 0:
                {
    ...
    typedef tars::TC_AutoPtr<Yolov5HttpPrxCallback> Yolov5HttpPrxCallbackPtr;

    //callback of promise async proxy for client
    class Yolov5HttpPrxCallbackPromise: public tars::ServantProxyCallback
    {
    public:
        virtual ~Yolov5HttpPrxCallbackPromise(){}
    public:
        ...
        typedef tars::TC_AutoPtr< Yolov5HttpPrxCallbackPromise::Promisetest > PromisetestPtr;

        Yolov5HttpPrxCallbackPromise(const tars::Promise< Yolov5HttpPrxCallbackPromise::PromisetestPtr > &promise)
        : _promise_test(promise)
        {}
        
        virtual void callback_test(const Yolov5HttpPrxCallbackPromise::PromisetestPtr &ptr)
        {
    ...
    protected:
        tars::Promise< Yolov5HttpPrxCallbackPromise::PromisetestPtr > _promise_test;
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Yolov5Http_all, __Yolov5Http_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Yolov5Http_all)
            {
                case 0:
                {
                    ...
                    Yolov5HttpPrxCallbackPromise::PromisetestPtr ptr = new Yolov5HttpPrxCallbackPromise::Promisetest();
    ...
    typedef tars::TC_AutoPtr<Yolov5HttpPrxCallbackPromise> Yolov5HttpPrxCallbackPromisePtr;

    /* callback of coroutine async proxy for client */
    class Yolov5HttpCoroPrxCallback: public Yolov5HttpPrxCallback
    {
    public:
        virtual ~Yolov5HttpCoroPrxCallback(){}
    public:
    ...
    typedef tars::TC_AutoPtr<Yolov5HttpCoroPrxCallback> Yolov5HttpCoroPrxCallbackPtr;

    /* proxy for client */
    class Yolov5HttpProxy : public tars::ServantProxy
    {
    public:
        ...
        void async_test(Yolov5HttpPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *_pSptd_ = ServantProxyThreadData::getData();
        ...
        tars::Future< Yolov5HttpPrxCallbackPromise::PromisetestPtr > promise_async_test(const map<string, string>& context)
        {
            tars::Promise< Yolov5HttpPrxCallbackPromise::PromisetestPtr > promise;
            Yolov5HttpPrxCallbackPromisePtr callback = new Yolov5HttpPrxCallbackPromise(promise);
        ...
        void coro_test(Yolov5HttpCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
        ...
        Yolov5HttpProxy* tars_hash(uint32_t key)
        {
            return (Yolov5HttpProxy*)ServantProxy::tars_hash(key);
        }

        Yolov5HttpProxy* tars_consistent_hash(uint32_t key)
        {
            return (Yolov5HttpProxy*)ServantProxy::tars_consistent_hash(key);
        }

        Yolov5HttpProxy* tars_open_trace(bool traceParam = false)
        {
            return (Yolov5HttpProxy*)ServantProxy::tars_open_trace(traceParam);
        }

        Yolov5HttpProxy* tars_set_timeout(int msecond)
        {
            return (Yolov5HttpProxy*)ServantProxy::tars_set_timeout(msecond);
        }

        static const char* tars_prxname() { return "Yolov5HttpProxy"; }
    };
    typedef tars::TC_AutoPtr<Yolov5HttpProxy> Yolov5HttpPrx;

    /* servant for server */
    class Yolov5Http : public tars::Servant
    {
    public:
        virtual ~Yolov5Http(){}
    ...
    public:
        ...
        {
            static ::std::string __dummy__Yolov5Http_all[]=
            {
                "test"
            };

            pair<string*, string*> r = equal_range(__dummy__Yolov5Http_all, __dummy__Yolov5Http_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __dummy__Yolov5Http_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
